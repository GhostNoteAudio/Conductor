...
void writeCc(int sliderNum, int midiValue)
{
    ...
    // Send MSB
    uint8_t dataMSB[3];
    dataMSB[0] = midiChannel[sliderNum] | 0xB0;
    dataMSB[1] = midiCC[sliderNum];
    dataMSB[2] = msb;
    usb_midi.write(dataMSB, 3);

    // Send LSB
    uint8_t dataLSB[3];
    dataLSB[0] = midiChannel[sliderNum] | 0xB0;
    dataLSB[1] = midiCC[sliderNum] + 32;
    dataLSB[2] = lsb;
    usb_midi.write(dataLSB, 3);
}
