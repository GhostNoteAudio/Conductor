...
extern "C" void flash_range_erase2(uint32_t flash_offs, size_t count);
extern "C" void flash_range_program2(uint32_t flash_offs, const uint8_t *data, size_t count);
...
bool EEPROMClass::commit() {
    ...
    noInterrupts();
    flash_range_erase2((intptr_t)_sector - (intptr_t)XIP_BASE, 4096);
    flash_range_program2((intptr_t)_sector - (intptr_t)XIP_BASE, _data, _size);
    interrupts();
